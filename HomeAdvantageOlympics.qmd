...
# Creating data table for differences between host/not host countries for a given olympics, as advised by Prof. Hardin to permute **within** the team
...
perm_stats |> 
  ...
  labs(title = "Permutation Test for Host Advantage/Disadvantage by Differences in Averages for Host or Not Host Countries",
