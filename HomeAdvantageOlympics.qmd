...
This means that athletes who are qualified to the Olympics are 44.7% more likely (we take the ratio between what the black line is showing with the red), on average, to score a medal if their country is <i>not</i> the host for that year, according to our data set.
...
perm_stats |> 
  summarize("Disadvantage", p_value_avg = 2 * mean(perm_avg_diff < points_avg_diff))
